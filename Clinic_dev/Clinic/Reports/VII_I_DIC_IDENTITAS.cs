...
{
    public partial class VII_I_DIC_IDENTITAS : DevExpress.XtraReports.UI.XtraReport
    {
        public VII_I_DIC_IDENTITAS() {
            InitializeComponent();
        }
        public VII_I_DIC_IDENTITAS(DataTable dtDetail = null)
        {
            InitializeComponent();
